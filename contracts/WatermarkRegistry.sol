...
contract WatermarkRegistry {
    ...
    function anchorWatermark(
        ...
        require(
            watermarkHash != bytes32(0),
            "WatermarkRegistry: invalid watermark hash"
        );
        require(
            contentHash != bytes32(0),
            "WatermarkRegistry: invalid content hash"
        );
        ...
        require(
            ...
            "WatermarkRegistry: anchor exists"
        );
    ...
    function getAnchor(
        bytes32 anchorId
    ) external view returns (WatermarkAnchor memory) {
